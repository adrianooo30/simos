<div
    class="card-box widget-user border-top border-bottom  {{ is_null($notification['read_at'])? 'bg-light-blue' : ''}} --notif-card"
    data-notification-id="{{ $notification['id'] }}">
    <div class="row">
        <div class="col-xl-2">
            <div class="avatar-lg float-left">
                <img src="{{ asset( $data['product_img'] ) }}" class="img-fluid rounded-circle" width="50">
            </div>
        </div>
        <div class="col-xl-7">
