...
@section('title-of-page')
	<i class="ti-direction fa-lg"></i> <span>Expired Products</span>
@endsection
	...
	<div class="row">
    	<div class="col-xl-12">
            <div class="card-box">
                ...
                {{-- title --}}
                <h4 class="header-title text-primary mt-0 mb-3">Table of Expired Products</h4>

                {{-- sections content --}}
				<table id="expired-products-table" class="table table-striped bg-white text-center" style="width: 100%;">
...
@section('scripts')
	...
	<script src="{{asset('js/datatables/expired.js')}}" type="text/javascript"></script>
	<script src="{{ asset('/js/inventory/expired.js') }}" type="text/javascript"></script>
